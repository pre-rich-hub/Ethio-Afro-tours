        ...
        <div className="grid gap-16 lg:grid-cols-2">
          <Reveal>
            <p className="mb-6 flex items-center gap-3 text-[12px] font-medium uppercase tracking-[0.24em] text-accent">
              ...
              {t('why.eyebrow', 'Why Ethiopia')}
            </p>
            <h2 className="max-w-[15ch] text-balance font-serif text-4xl leading-[1.1] sm:text-5xl lg:text-6xl">
              {t('why.title', 'Why here, and not anywhere else?')}
            </h2>
            <div className="mt-8 space-y-6 text-lg leading-relaxed text-secondary-foreground/80">
              <p>
                {t('why.p1', 'While the rest of the continent offers the familiar, Ethiopia offers the extraordinary. This is the birthplace of coffee, the home of ancient Christian kingdoms, and a landscape that ranges from cloud-wrapped peaks to the lowest, hottest place on earth.')}
              </p>
              <p>
                {t('why.p2', 'Travelers do not simply visit Ethiopia. They leave with a changed sense of how old, how varied, and how welcoming the world can be.')}
              </p>
            </div>
          </Reveal>
