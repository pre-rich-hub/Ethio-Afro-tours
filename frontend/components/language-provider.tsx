...
const dictionaries: Record<LanguageCode, Dictionary> = {
  ...
  ES: {
    ...
    'hero.primary': 'Explorar Tours',
    'hero.secondary': 'Contáctenos',
    ...
    'accessNote.label': 'Acceso actual',
    'destination.gheralta-mountains.name': 'Montañas de Gheralta e Iglesias Rupestres',
    'destination.gheralta-mountains.region': 'Tierras Altas de Tigray',
    'destination.gheralta-mountains.tag': 'Paisaje Sagrado',
    'destination.gheralta-mountains.teaser': 'Pináculos de arenisca, senderos de acantilado y antiguos santuarios sobre las llanuras de Tigray.',
    'destination.awash-national-park.name': 'Parque Nacional Awash',
    'destination.awash-national-park.region': 'Rift Valley Oriental',
    'destination.awash-national-park.tag': 'Parque Nacional',
    'destination.awash-national-park.teaser': 'Sabana de acacias, llanuras volcánicas y fauna alrededor del desfiladero del río Awash.',
    'destination.lake-langano.name': 'Lago Langano y Rift Valley Central',
    'destination.lake-langano.region': 'Rift Valley Central',
    'destination.lake-langano.tag': 'Lagos y Aves',
    'destination.lake-langano.teaser': 'Un lago cobrizo de playas tranquilas, senderos boscosos y abundante avifauna.',
    'destination.gedeo-cultural-landscape.name': 'Paisaje Cultural de Gedeo',
    'destination.gedeo-cultural-landscape.region': 'Tierras Altas del Sur',
    'destination.gedeo-cultural-landscape.tag': 'Patrimonio UNESCO',
    'destination.gedeo-cultural-landscape.teaser': 'Un mosaico vivo donde café, enset, bosque sagrado y conocimiento comunitario crecen juntos.',
    'destination.kafa-biosphere-reserve.name': 'Reserva de Biosfera de Kafa',
    'destination.kafa-biosphere-reserve.region': 'Suroeste de Etiopía',
    'destination.kafa-biosphere-reserve.tag': 'Bosque de Café',
    'destination.kafa-biosphere-reserve.teaser': 'Arábica silvestre bajo el bosque afromontano, con senderos, cascadas y aves singulares.',
    'tour.gheralta-rock-churches-and-aksum.title': 'Iglesias Rupestres de Gheralta y Aksum',
    'tour.gheralta-rock-churches-and-aksum.style': 'Senderismo Sagrado · Privado',
    'tour.gheralta-rock-churches-and-aksum.teaser': 'Camine entre santuarios de acantilado antes de descubrir las estelas y tradiciones de Aksum.',
    'tour.awash-and-harar-eastern-ethiopia.title': 'Awash y Harar: Etiopía Oriental',
    'tour.awash-and-harar-eastern-ethiopia.style': 'Fauna y Cultura · Privado',
    'tour.awash-and-harar-eastern-ethiopia.teaser': 'Una la sabana y el río Awash con la historia ferroviaria de Dire Dawa y las callejuelas de Harar.',
    'tour.rift-valley-lakes-and-langano.title': 'Lagos del Rift Valley y Langano',
    'tour.rift-valley-lakes-and-langano.style': 'Lagos y Aves · Privado',
    'tour.rift-valley-lakes-and-langano.teaser': 'Viaje despacio entre Ziway, Langano y Hawassa, con humedales, aves y tiempo junto al lago.',
    'tour.gedeo-living-landscape.title': 'Paisaje Vivo de Gedeo y Yirgacheffe',
    'tour.gedeo-living-landscape.style': 'Patrimonio Vivo · Privado',
    'tour.gedeo-living-landscape.teaser': 'Explore un paisaje agroforestal UNESCO mediante caminatas, bosque sagrado, megalitos y café de origen.',
    'tour.kafa-forest-trekking-and-birding.title': 'Trekking y Avistamiento de Aves en Kafa',
    'tour.kafa-forest-trekking-and-birding.style': 'Expedición Forestal · Privado',
    'tour.kafa-forest-trekking-and-birding.teaser': 'Recorra el bosque de café silvestre buscando aves, cascadas y biodiversidad viva.',
  ...
  FR: {
    ...
    'nav.layover': 'Escale',
    'nav.journal': 'Journal',
    'nav.request': 'Réserver Maintenant',
    'nav.language': 'Langue',
    ...
    'hero.primary': 'Explorer les Circuits',
    ...
    'accessNote.label': 'Accès actuel',
    'destination.gheralta-mountains.name': 'Montagnes du Gheralta et Églises Rupestres',
    'destination.gheralta-mountains.region': 'Hautes Terres du Tigré',
    'destination.gheralta-mountains.tag': 'Paysage Sacré',
    'destination.gheralta-mountains.teaser': 'Des pinacles de grès, des sentiers en falaise et d’anciens sanctuaires au-dessus des plaines du Tigré.',
    'destination.awash-national-park.name': 'Parc National de l’Awash',
    'destination.awash-national-park.region': 'Rift Oriental',
    'destination.awash-national-park.tag': 'Parc National',
    'destination.awash-national-park.teaser': 'Savane d’acacias, plaines volcaniques et faune autour des gorges de l’Awash.',
    'destination.lake-langano.name': 'Lac Langano et Rift Central',
    'destination.lake-langano.region': 'Rift Central',
    'destination.lake-langano.tag': 'Lacs et Oiseaux',
    'destination.lake-langano.teaser': 'Un lac cuivré bordé de plages calmes, de sentiers boisés et d’une avifaune abondante.',
    'destination.gedeo-cultural-landscape.name': 'Paysage Culturel du Pays Gedeo',
    'destination.gedeo-cultural-landscape.region': 'Hautes Terres du Sud',
    'destination.gedeo-cultural-landscape.tag': 'Patrimoine UNESCO',
    'destination.gedeo-cultural-landscape.teaser': 'Une mosaïque vivante où café, enset, forêt sacrée et savoir communautaire grandissent ensemble.',
    'destination.kafa-biosphere-reserve.name': 'Réserve de Biosphère de Kafa',
    'destination.kafa-biosphere-reserve.region': 'Sud-Ouest de l’Éthiopie',
    'destination.kafa-biosphere-reserve.tag': 'Forêt de Café',
    'destination.kafa-biosphere-reserve.teaser': 'De l’arabica sauvage sous la forêt afromontagnarde, entre sentiers, cascades et oiseaux rares.',
    'tour.gheralta-rock-churches-and-aksum.title': 'Églises Rupestres du Gheralta et Aksum',
    'tour.gheralta-rock-churches-and-aksum.style': 'Randonnée Sacrée · Privé',
    'tour.gheralta-rock-churches-and-aksum.teaser': 'Marchez entre les sanctuaires en falaise avant de découvrir les stèles et traditions d’Aksum.',
    'tour.awash-and-harar-eastern-ethiopia.title': 'Awash et Harar : Éthiopie Orientale',
    'tour.awash-and-harar-eastern-ethiopia.style': 'Faune et Culture · Privé',
    'tour.awash-and-harar-eastern-ethiopia.teaser': 'Reliez la savane et la rivière Awash au patrimoine ferroviaire de Dire Dawa et aux ruelles de Harar.',
    'tour.rift-valley-lakes-and-langano.title': 'Lacs du Rift et Escapade à Langano',
    'tour.rift-valley-lakes-and-langano.style': 'Lacs et Oiseaux · Privé',
    'tour.rift-valley-lakes-and-langano.teaser': 'Ralentissez entre Ziway, Langano et Hawassa, au fil des zones humides et des oiseaux.',
    'tour.gedeo-living-landscape.title': 'Paysage Vivant du Gedeo et Yirgacheffe',
    'tour.gedeo-living-landscape.style': 'Patrimoine Vivant · Privé',
    'tour.gedeo-living-landscape.teaser': 'Explorez un paysage agroforestier UNESCO entre marches, forêt sacrée, mégalithes et café d’origine.',
    'tour.kafa-forest-trekking-and-birding.title': 'Randonnée et Ornithologie dans la Forêt de Kafa',
    'tour.kafa-forest-trekking-and-birding.style': 'Expédition Forestière · Privé',
    'tour.kafa-forest-trekking-and-birding.teaser': 'Parcourez la forêt de café sauvage à la recherche d’oiseaux, de cascades et de biodiversité.',
  ...
  DE: {
    ...
    'accessNote.label': 'Aktueller Zugang',
    'destination.gheralta-mountains.name': 'Gheralta-Berge und Felsenkirchen',
    'destination.gheralta-mountains.region': 'Hochland von Tigray',
    'destination.gheralta-mountains.tag': 'Heilige Landschaft',
    'destination.gheralta-mountains.teaser': 'Sandsteinzinnen, Klippenpfade und alte Heiligtümer über den Ebenen von Tigray.',
    'destination.awash-national-park.name': 'Awash-Nationalpark',
    'destination.awash-national-park.region': 'Östlicher Grabenbruch',
    'destination.awash-national-park.tag': 'Nationalpark',
    'destination.awash-national-park.teaser': 'Akaziensavanne, vulkanische Ebenen und Wildtiere an der Schlucht des Awash-Flusses.',
    'destination.lake-langano.name': 'Langano-See und Zentraler Grabenbruch',
    'destination.lake-langano.region': 'Zentraler Grabenbruch',
    'destination.lake-langano.tag': 'Seen und Vogelwelt',
    'destination.lake-langano.teaser': 'Ein kupferfarbener See mit ruhigen Stränden, Waldwegen und reicher Vogelwelt.',
    'destination.gedeo-cultural-landscape.name': 'Gedeo-Kulturlandschaft',
    'destination.gedeo-cultural-landscape.region': 'Südliches Hochland',
    'destination.gedeo-cultural-landscape.tag': 'UNESCO-Welterbe',
    'destination.gedeo-cultural-landscape.teaser': 'Ein lebendiges Mosaik, in dem Kaffee, Enset, heiliger Wald und Gemeinschaftswissen zusammenwachsen.',
    'destination.kafa-biosphere-reserve.name': 'Kafa-Biosphärenreservat',
    'destination.kafa-biosphere-reserve.region': 'Südwestäthiopien',
    'destination.kafa-biosphere-reserve.tag': 'Kaffeewald',
    'destination.kafa-biosphere-reserve.teaser': 'Wilder Arabica unter afromontanem Wald, durchzogen von Wegen, Wasserfällen und seltenen Vögeln.',
    'tour.gheralta-rock-churches-and-aksum.title': 'Gheralta-Felsenkirchen und Aksum',
    'tour.gheralta-rock-churches-and-aksum.style': 'Heilige Wanderung · Privat',
    'tour.gheralta-rock-churches-and-aksum.teaser': 'Wandern Sie zwischen Klippenheiligtümern und entdecken Sie anschließend die Stelen und Traditionen Aksums.',
    'tour.awash-and-harar-eastern-ethiopia.title': 'Awash und Harar: Ostäthiopien',
    'tour.awash-and-harar-eastern-ethiopia.style': 'Wildnis und Kultur · Privat',
    'tour.awash-and-harar-eastern-ethiopia.teaser': 'Verbinden Sie die Awash-Savanne mit Dire Dawas Eisenbahngeschichte und Harars Gassen.',
    'tour.rift-valley-lakes-and-langano.title': 'Seen des Grabenbruchs und Langano',
    'tour.rift-valley-lakes-and-langano.style': 'Seen und Vogelwelt · Privat',
    'tour.rift-valley-lakes-and-langano.teaser': 'Reisen Sie langsam zwischen Ziway, Langano und Hawassa mit Feuchtgebieten und Zeit am See.',
    'tour.gedeo-living-landscape.title': 'Lebendige Gedeo-Landschaft und Yirgacheffe',
    'tour.gedeo-living-landscape.style': 'Lebendiges Erbe · Privat',
    'tour.gedeo-living-landscape.teaser': 'Erleben Sie eine UNESCO-Agrarlandschaft mit Wanderungen, heiligem Wald, Megalithen und Kaffee.',
    'tour.kafa-forest-trekking-and-birding.title': 'Waldwandern und Vogelbeobachtung in Kafa',
    'tour.kafa-forest-trekking-and-birding.style': 'Waldexpedition · Privat',
    'tour.kafa-forest-trekking-and-birding.teaser': 'Durchwandern Sie wilden Kaffeewald auf der Suche nach Vögeln, Wasserfällen und Biodiversität.',
  ...
  ZH: {
    ...
    'tour.view': '查看行程',
    'accessNote.label': '当前通行情况',
    'destination.gheralta-mountains.name': '盖拉尔塔山脉与岩凿教堂',
    'destination.gheralta-mountains.region': '提格雷高地',
    'destination.gheralta-mountains.tag': '神圣景观',
    'destination.gheralta-mountains.teaser': '砂岩峰林、悬崖小径与俯瞰提格雷平原的古老圣所。',
    'destination.awash-national-park.name': '阿瓦什国家公园',
    'destination.awash-national-park.region': '东部裂谷',
    'destination.awash-national-park.tag': '国家公园',
    'destination.awash-national-park.teaser': '金合欢草原、火山平原与汇聚在阿瓦什河峡谷周围的野生动物。',
    'destination.lake-langano.name': '兰加诺湖与中央裂谷',
    'destination.lake-langano.region': '中央裂谷',
    'destination.lake-langano.tag': '湖泊与鸟类',
    'destination.lake-langano.teaser': '铜色湖水、宁静沙滩、林间小径与丰富的裂谷鸟类。',
    'destination.gedeo-cultural-landscape.name': '盖德奥文化景观',
    'destination.gedeo-cultural-landscape.region': '南部高地',
    'destination.gedeo-cultural-landscape.tag': '联合国教科文组织遗产',
    'destination.gedeo-cultural-landscape.teaser': '咖啡、恩塞特、圣林与社区智慧共同生长的鲜活高地景观。',
    'destination.kafa-biosphere-reserve.name': '卡法生物圈保护区',
    'destination.kafa-biosphere-reserve.region': '埃塞俄比亚西南部',
    'destination.kafa-biosphere-reserve.tag': '咖啡森林',
    'destination.kafa-biosphere-reserve.teaser': '非洲山地森林下的野生阿拉比卡咖啡、林间小径、瀑布与珍稀鸟类。',
    'tour.gheralta-rock-churches-and-aksum.title': '盖拉尔塔岩凿教堂与阿克苏姆之旅',
    'tour.gheralta-rock-churches-and-aksum.style': '神圣徒步 · 私人',
    'tour.gheralta-rock-churches-and-aksum.teaser': '徒步探访悬崖圣所，再解读阿克苏姆的石碑与古老传统。',
    'tour.awash-and-harar-eastern-ethiopia.title': '阿瓦什与哈勒尔：埃塞俄比亚东部',
    'tour.awash-and-harar-eastern-ethiopia.style': '野生动物与文化 · 私人',
    'tour.awash-and-harar-eastern-ethiopia.teaser': '从阿瓦什草原与河谷，走向德雷达瓦铁路历史和哈勒尔古巷。',
    'tour.rift-valley-lakes-and-langano.title': '裂谷湖泊与兰加诺休闲之旅',
    'tour.rift-valley-lakes-and-langano.style': '湖泊与观鸟 · 私人',
    'tour.rift-valley-lakes-and-langano.teaser': '慢游济瓦伊、兰加诺与阿瓦萨，探索湿地鸟类并享受湖畔时光。',
    'tour.gedeo-living-landscape.title': '盖德奥活态景观与耶加雪菲',
    'tour.gedeo-living-landscape.style': '活态遗产 · 私人',
    'tour.gedeo-living-landscape.teaser': '通过徒步、圣林、巨石遗迹与产地咖啡探索联合国教科文组织农林景观。',
    'tour.kafa-forest-trekking-and-birding.title': '卡法森林徒步与观鸟',
    'tour.kafa-forest-trekking-and-birding.style': '森林探险 · 私人',
    'tour.kafa-forest-trekking-and-birding.teaser': '与当地自然向导穿行野生咖啡森林，寻找鸟类、瀑布与鲜活的生物多样性。',
...
assignDestinationTranslations(
  'ES',
  {
    ...
    'destinationsPage.hero.title': 'Veinticinco lugares y las rutas entre ellos',
    'destinationsPage.hero.lede':
      'Desde iglesias talladas en la roca hasta bosques de café silvestre y un lago de lava bajo el nivel del mar. Estos son veinticinco lugares que nuestros diseñadores conectan en viajes por Etiopía.',
...
assignDestinationTranslations(
  'FR',
  {
    ...
    'destinationsPage.hero.title': 'Vingt-cinq lieux, et les routes entre eux',
    'destinationsPage.hero.lede':
      'Des églises creusées dans la roche aux forêts de café sauvage et à un lac de lave sous le niveau de la mer, voici vingt-cinq lieux reliés en voyages réfléchis.',
    'destinationsPage.hero.imageAlt':
...
assignDestinationTranslations(
  'DE',
  {
    ...
    'destinationsPage.hero.title': 'Fünfundzwanzig Orte und die Routen dazwischen',
    'destinationsPage.hero.lede':
      'Von Felsenkirchen über wilde Kaffeewälder bis zu einem Lavasee unter dem Meeresspiegel: Diese fünfundzwanzig Orte verbinden wir zu durchdachten Reisen.',
...
assignDestinationTranslations(
  'ZH',
  {
    ...
    'destinationsPage.hero.title': '二十五个地点，以及连接它们的路线',
    'destinationsPage.hero.lede':
      '从岩凿教堂、野生咖啡森林到海平面以下的熔岩湖，这二十五个地点被串联成细致的埃塞俄比亚旅程。',
...
assignTourPageTranslations(
  'ES',
  {
    ...
    'toursPage.hero.title': 'Veinte rutas, ninguna fija',
    'toursPage.hero.lede':
...
assignTourPageTranslations(
  'FR',
  {
    ...
    'toursPage.hero.title': 'Vingt itinéraires, aucun figé',
    'toursPage.hero.lede':
...
assignTourPageTranslations(
  'DE',
  {
    ...
    'toursPage.hero.title': 'Zwanzig Routen, keine davon starr',
    'toursPage.hero.lede':
...
assignTourPageTranslations(
  'ZH',
  {
    ...
    'toursPage.hero.title': '二十条路线，没有一条固定',
    'toursPage.hero.lede':
