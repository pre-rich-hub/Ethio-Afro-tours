    ...
    <div className="p-8">
      ...
      {replyingTo && (
        <form onSubmit={sendReply} className="mb-8 rounded-xl border border-accent/30 bg-card p-6 shadow-sm" data-testid="contact-reply-form">
          ...
          <div className="grid gap-5"><label><span className={adminLabelClass}>Subject</span><input name="subject" defaultValue="Your EthioAfro Tours inquiry" className={adminInputClass} required /></label><label><span className={adminLabelClass}>Message</span><textarea name="message" className={`${adminInputClass} min-h-36 resize-y`} required /></label></div>
