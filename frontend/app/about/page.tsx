...
export default function AboutPage() {
  return (
    <>
      <PageHero
        eyebrow="About Ethio Afro Tours"
        title="Private journeys through Ethiopia, shaped with local expertise"
        lede="A fully licensed Addis Ababa-based tour operator creating private, personalized and deeply authentic journeys throughout Ethiopia."
        image="/images/hero-lalibela.png"
        imageAlt="The rock-hewn churches of Lalibela in warm evening light"
        crumbs={[{ label: 'Home', href: '/' }, { label: 'About Us' }]}
        meta={[
          { label: 'Experience', value: '15+ Years' },
          { label: 'Base', value: 'Addis Ababa' },
          { label: 'Memberships', value: 'Tourism Ethiopia' },
      ...
      <section className="shell grid gap-12 py-16 sm:py-20 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20 lg:py-28">
        <Reveal>
          ...
          <h2 className="max-w-[18ch] text-balance text-3xl leading-[1.08] text-foreground sm:text-4xl lg:text-5xl">
            Ethiopia, designed with local authority and quiet precision
          </h2>
          <div className="mt-7 space-y-5 text-pretty leading-relaxed text-muted-foreground sm:text-lg">
            <p>
              Ethio Afro Tours is a fully licensed luxury tour operator and
              destination management company based in Addis Ababa, Ethiopia.
              With more than 15 years of experience, we create private,
              personalized, and authentic journeys throughout the country.
            </p>
            <p>
              The company is officially authorized in Ethiopia and is a member
              of the Ethiopian Tour Operators Association and Tourism Ethiopia.
            </p>
            <p>
              From the ancient rock-hewn churches of Lalibela and the
              breathtaking Simien Mountains to the diverse cultures of the Omo
              Valley and the extraordinary landscapes of the Danakil Depression,
              we help travelers experience the very best of Ethiopia.
            </p>
            <p>
              Every tour is carefully designed around our guests’ interests,
              schedule, comfort, travel style, and budget.
            </p>
          </div>
          ...
          <div className="relative overflow-hidden border border-border bg-card">
            <div className="relative aspect-[4/5] min-h-[460px]">
              <Image
                ...
                alt="A traveler overlooking the Ethiopian highlands"
                fill
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 text-background sm:p-8">
                ...
                <p className="mt-3 max-w-sm font-serif text-2xl leading-tight sm:text-3xl">
                  Licensed in Ethiopia and connected to the country’s leading
      ...
      <section className="border-y border-border bg-muted/40">
        <div className="shell py-16 sm:py-20 lg:py-28">
          <SectionHeading
            eyebrow="Credentials"
            title="Licensed, local and professionally connected"
            aside="Our operation is rooted in Ethiopia, with the authorizations, memberships and local relationships needed to coordinate complex private travel with confidence."
          />
        ...
        <div className="shell grid gap-10 py-16 sm:py-20 lg:grid-cols-2 lg:gap-16 lg:py-28">
          <Reveal className="border-t border-background/20 pt-7">
            ...
            <h2 className="max-w-xl text-balance font-serif text-3xl leading-[1.1] sm:text-4xl">
              To be one of Ethiopia’s most trusted luxury tour operators.
            </h2>
            <p className="mt-6 max-w-xl text-pretty leading-relaxed text-background/70 sm:text-lg">
              Recognized for exceptional service, authentic experiences,
              responsible tourism, and meaningful connections with local
              communities.
            </p>
          </Reveal>
          ...
          <Reveal delay={120} className="border-t border-background/20 pt-7">
            ...
            <h2 className="max-w-xl text-balance font-serif text-3xl leading-[1.1] sm:text-4xl">
              To deliver safe, professional, personalized and high-quality
              tours.
            </h2>
            <p className="mt-6 max-w-xl text-pretty leading-relaxed text-background/70 sm:text-lg">
              We support local communities and protect Ethiopia’s cultural and
              natural heritage while creating journeys that feel personal,
              polished and honest.
            </p>
          </Reveal>
        </div>
      ...
      <section className="shell py-16 sm:py-20 lg:py-28">
        <SectionHeading
          ...
          title="Journeys shaped around the way you want to experience Ethiopia"
          aside="We arrange luxury vacations, cultural and historical journeys, wildlife adventures, trekking expeditions, photography tours, and family holidays."
        />
      ...
      <section className="border-y border-border bg-muted/35">
        <div className="shell py-16 sm:py-20 lg:py-28">
          <SectionHeading
            eyebrow="Why Travel With Ethio Afro Tours?"
            title="Luxury is in the details you never have to chase"
            align="center"
          />
      ...
      <section className="shell grid gap-10 py-16 sm:py-20 lg:grid-cols-[0.9fr_1.1fr] lg:gap-16 lg:py-28">
        <Reveal className="relative min-h-[420px] overflow-hidden">
          <Image
            ...
            alt="A luxury lodge prepared for travelers in Ethiopia"
            fill
            sizes="(max-width: 1024px) 100vw, 44vw"
            className="object-cover"
          />
        ...
        <Reveal delay={120} className="self-center">
          ...
          <h2 className="max-w-[18ch] text-balance text-3xl leading-[1.08] text-foreground sm:text-4xl lg:text-5xl">
            Let our local team create a private Ethiopia tour designed
            especially for you.
          </h2>
          <p className="mt-7 max-w-xl text-pretty leading-relaxed text-muted-foreground sm:text-lg">
            From arrival to departure, our Addis Ababa-based team coordinates
            your route, guides, accommodations, vehicles and pacing so you can
            explore Ethiopia with comfort and confidence.
          </p>
          <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <LinkButton href="/contact" variant="gold">
              Plan Your Ethiopia Tour
            </LinkButton>
